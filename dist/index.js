...
const environmentalPerformanceIndexLayers = {
    wasteManagement: "epi:epi-environmental-performance-index-2020_hlt-waste-management",
    sanitationAndDrinkingWater: "epi:epi-environmental-performance-index-2020_hlt-sanitation-and-drinking-water",
    ...
    waterResources: "epi:epi-environmental-performance-index-2020_eco-water-resources",
    pollutionEmission: "epi:epi-environmental-performance-index-2020_eco-pollution-emissions",
    fisheries: "epi:epi-environmental-performance-index-2020_eco-fisheries",
    climateChange: "epi:epi-environmental-performance-index-2020_eco-climate-change",
    biodiversityAndHabitat: "epi:epi-environmental-performance-index-2020_eco-biodiversity-and-habitat",
    agriculture: "epi:epi-environmental-performance-index-2020_eco-agriculture",
    ecosystemServices: "epi:epi-environmental-performance-index-2020_eco-ecosystem-services",
};
const agriculture = L.tileLayer.wms("https://sedac.ciesin.columbia.edu/geoserver/wms", {
...
let overlayMaps = {
    ...
    "<span class='control-span'>Biodiversity and Habitat</span>": map.addTileLayerWMS({
    ...
    "<span class='control-span'>Sanitation and Drinking Water</span>": map.addTileLayerWMS({
...
const setLegendImageUrl = () => {
    ...
    switch (layerName) {
        ...
        case "Biodiversity and Habitat":
            url = map.makeUrl(environmentalPerformanceIndexLayers.biodiversityAndHabitat);
            break;
        case "Climate Change":
        ...
        case "Sanitation and Drinking Water":
            url = map.makeUrl(environmentalPerformanceIndexLayers.sanitationAndDrinkingWater);
            break;
...
layerElement?.addEventListener("click", function () {
    ...
    map.addLegend({ layerName: layerName, url: legendProperties.url }, "legend", "map-header");
});
